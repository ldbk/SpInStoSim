...
```{r}
load("~/DOC/AUTRE/git/SpInStoSim/data/simu_stock/out/0.6/lh/simsSP202010071531.RData")
simsSP<-sims
load("~/DOC/AUTRE/git/SpInStoSim/data/simu_stock/out/0.6/lh/simsLP202010071537.RData")
simsLP<-sims
load("~/DOC/AUTRE/git/SpInStoSim/data/simu_stock/out/0.6/lh/simsDE202010071534.RData")
simsDE<-sims
```

```{r}
catch<-data.frame(Stock=rep(simsDE$DE_ID0_AR_ED0_SELF_UR0_TS60$code, length(sims[["DE_ID0_AR_ED0_SELF_UR0_TS60"]][["catch"]]@.Data[,,,,,1])), 
                            yr=seq(1, length(sims[["DE_ID0_AR_ED0_SELF_UR0_TS60"]][["catch"]]@.Data[,,,,,1])), ct=sims[["DE_ID0_AR_ED0_SELF_UR0_TS60"]][["catch"]]@.Data[,,,,,1]
                 # , bt=sims[["DE_ID0_AR_ED0_SELF_UR0_TS60"]][["biomass"]]@.Data[,,,,,1]
                  )
```
...
#-----------------------------------------
#set working directory in the good place 
#catch_file  <-  "catch_CMSY.csv" #  name of file containing "stock", "yr", "ct", and optional "bt"
catch_file<-catch
#id_file     <-  "parameters_cmsy.csv"  #  name of file containing stock-specific info and settings for the analysis
...
#----------------------------------------
stocks      <-c("DE_ID0_AR_ED0_SELF_UR0_TS60")
